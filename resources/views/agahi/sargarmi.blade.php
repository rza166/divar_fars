...
@if (!empty($codemeliC))
  <span class="labela4" for="">کد ملی</span>
  <input  type="text" id="codemeli" class="a2-3"  onkeypress='validate(event)' >
@endif
...
@section('agahi3')
<div class="a2-6">
<button type="button" onclick="savegame('{{$menu}}','{{$collection}}')" class="btn btn-danger">ارسال آگهی</button>
</div>
@endsection
@endsection
