       ...
       <ul class="ul2 ul2-1">
           <li  class="li_5 lia1" data-show2="show" onclick="showMenu2('li1','lia1','ula1')">اجاره مسکونی(آپارتمان،خانه،زمین) <i class='fas fa-chevron-left e43' style='font-size:21px'></i></li>
               <ul class="ul22_s ula1">
                 <li onclick="amlak('lia1','','',111)"><i class='fas fa-check-square e43' style='font-size:24px'></i>آپارتمان</li>
                 <li onclick="amlak('lia1','','',112)"> <i class='fas fa-check-square e43' style='font-size:24px'></i>خانه و ویلا</li>
